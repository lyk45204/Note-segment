...
parfor i_search = 1:n_search
    ...
    for i_files = 1:n_files
        ...
        path{i_files}  = hmmViterbi(obsProb{i_files}',tranProb_search,init);
    end
    ...
    for i_files = 1:n_files
        pitchtrack_piece = pitchtrack{n_files};
        noteout_piece = noteout{n_files};
        m_level_piece = m_level{n_files};
