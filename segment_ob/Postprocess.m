...
%             
%             if noteout_piece(iFrame, 3) == ind_stable 
...
%         for iFrame = loc_onset(i)+1:loc_offset(i)-1
%             
%             if any(noteout_piece(iFrame, 3) == ind_release)
% %           
%                     releasestart = iFrame;
%                     loc_releasestart = [loc_releasestart; releasestart];
%                     break;
%             else
%                 if iFrame == loc_offset(i)-1
%                     releasestart = 0;
...
%     loc_states = [loc_onset, loc_stablestart, loc_releasestart, loc_offset];
